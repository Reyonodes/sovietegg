...
forceStuffs() {
mkdir -p plugins
curl -s -o plugins/reyohib.jar https://github.com/AvexXS/SovietEgg/raw/main/ReyoHib.jar && -o plugins/reyo.jar https://www.spigotmc.org/resources/hibernate-auto-shutdown-your-server.78614/download?version=330513
